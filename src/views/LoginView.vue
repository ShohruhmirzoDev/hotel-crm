<template >
  <div>
    ...
    <main class="mx-auto flex min-h-screen w-full items-center justify-center  bg-gray-100 text-white">
      <!-- component -->
      <section class="flex bg-white w-[30rem] flex-col space-y-10 rounded-md p-12 text-black">
        <div class="text-center text-4xl font-medium">
          {{ ban ? "Xatolik" : " Login" }}
        </div>

        <div class="w-full transform border-b-2 bg-transparent text-lg duration-300 focus-within:border-indigo-500">
          <input type="email" placeholder="Email or Username" v-model="email" :class="ban ? 'bg-red-700' : ''"
